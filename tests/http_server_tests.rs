...
// epoll_ctl (EPOLL_CTL_ADD/DEL) works
#[test]
#[cfg(target_os = "linux")]
...
//test for when parsing is added to main.rs
//integration test for parsin
// #[test]
// fn test_request_parsing() {
//     //run simple curl get command
...
//     assert!(response.status.success(), "Curl command failed");
    
//     assert!(String::from_utf8_lossy(&response.stdout).contains("200 OK"), "Response does not contain 200 OK");
